...
export default function ClientTable({ query }: ClientTableProps) {
  const { data, loadNext, isLoadingNext, hasNext, refetch } =
    usePaginationFragment<ClientTablePaginationQuery, ClientTable_clients$key>(
      graphql`
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <Link to={`/clients/${row.id}`}>{row.name}</Link>
                    </TableCell>
                    <TableCell align="right">
                      {row.subscriptionStatus}
                    </TableCell>
                    <TableCell align="right">{row.subscriberCount}</TableCell>
                    <TableCell align="right">
                      <a href={row.subscribeLink} target="_blank">
                        {row.subscribeLink}
                      </a>
                    </TableCell>
                  </TableRow>
