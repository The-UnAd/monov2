...
public partial class ProductDbContext : DbContext
{
    ...
    public virtual DbSet<PriceTierFeature> PriceTierFeatures { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PriceTierFeature>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("price_tier_features_pkey");

            entity.ToTable("price_tier_features");
            ...
            entity.HasOne(d => d.PriceTier).WithMany(p => p.PriceTierFeatures)
                .HasForeignKey(d => d.PriceTierId)
                .OnDelete(DeleteBehavior.Cascade)
